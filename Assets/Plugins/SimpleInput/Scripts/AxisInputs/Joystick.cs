...
#pragma warning restore 0649
		...
		public float hydrolicSpeed;
		[SerializeField] private bool isHydrolic;
		private bool hydrolic;
		...
		private void OnUpdate()
		{
			...
			if (hydrolic)
			{
				m_value = Vector2.Lerp(m_value, Vector2.zero, hydrolicSpeed * Time.deltaTime);
